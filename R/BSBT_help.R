...
#' The covariance functions can be used to construct the Multivariate Normal prior distribution. The prior distirbution includes a constraint, where a linear combination of the parameters can be specified.
